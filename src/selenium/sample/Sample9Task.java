...
//         * but loading text is seen instead   "Loading green..."
        assertTrue(loadingColor.isStartGreenDisplayed());
...
//         * 3) check that both button
        ...
        assertEquals("Finish Green", finishGreen.getText());
//         * and loading text is not seen,
//         * success is seen instead "Green Loaded"
        assertFalse(startGreen.isDisplayed());
...
//         * but loading text is seen instead   "Loading green..."
        ...
        assertEquals("Loading green...", loadingGreen.getText());
//         * 3) check that both button
        wait.until(ExpectedConditions.presenceOfElementLocated(By.id("something")));
